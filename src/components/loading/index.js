/*
 * @Date         : 2020-05-06 17:42:49
 * @LastEditors  : 曾迪
 * @LastEditTime : 2020-05-06 17:46:10
 * @FilePath     : \kaoshi\src\components\loading\index.js
 * @Description  :
 */
const loadTemp = require('./Loading.vue').default // cli3.0以后引入vue模板需要default
...
Load.install = (Vue, options) => { // Vue的install方法，用于定义vue插件
  ...
  // 创建一个VUE构造器
  const lTemp = Vue.extend(loadTemp)
